...
- **Phase 4: Interactive TUI Dashboard (Completed)** - Implement a "Bubble Tea" based terminal interface for live monitoring, stats tracking, and hot-swapping configuration/models.
